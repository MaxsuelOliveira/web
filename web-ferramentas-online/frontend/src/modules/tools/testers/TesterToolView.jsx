...
import { useTesterTool } from "./useTesterTool";

export default function TesterToolView({ tool }) {
  const controller = useTesterTool(tool);
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="space-y-4 p-4">
          <div className="rounded-[20px] border border-cyan-100 bg-cyan-50/80 p-4">
            ...
            <p className="mt-2 text-[14px] leading-6 text-slate-600">
              Esses testes servem para validar se um dado esta correto ou para
              inspecionar um retorno tecnico. Preencha na ordem e execute quando
              o aviso abaixo ficar liberado.
            </p>
          </div>
            ...
            <div className="flex flex-col gap-3 rounded-[20px] border border-slate-200 bg-white/82 p-4 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-1 text-[14px] leading-6 text-slate-600">
                  {simpleMode
                    ? `Mostrando os campos essenciais primeiro. ${advancedFields} configuracao(oes) extra(s) ficam escondidas para simplificar.`
                    : "Todas as configuracoes tecnicas estao abertas."}
                </p>
              </div>
              <button
                type="button"
          ...
          <div className="rounded-[18px] border border-slate-100 bg-slate-50/90 p-3">
            ...
            <p className="mt-1.5 text-[13px] leading-5 text-slate-600">
              Ideal para validar payloads, testar regex, inspecionar tokens e
              revisar retornos tecnicos sem sair do navegador.
            </p>
          ...
          <form className="space-y-3" onSubmit={controller.submit}>
            ...
            <ToolFormActions
              submitLabel="Rodar teste"
              submitBusyLabel="Executando..."
              ...
              helperMessage={
                controller.isLoading
                  ? "Executando teste e preparando resposta."
                  : canSubmit
                  ? "Fluxo liberado para execucao."
      ...
      <ResultViewer
        ...
        emptyMessage="Preencha os parametros para disparar o teste."
